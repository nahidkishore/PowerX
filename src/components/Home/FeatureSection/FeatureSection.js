                ...
                <Row>
                    {
                        cards.map(card =>
                            <div className="col-12 col-md-4" key={card.id}>
                                <div className="feature-card" style={{ backgroundImage: `url(${card.bg})`, color: `${card.color}`, backgroundSize: 'cover', maxHeight: '600px', height: '350px'  }}>
                                    <div className="feature-content">
                                    <div className="img-top d-flex align-items-center justify-content-center" style={{height: '100px'}}>
                                        <img src={card.icon} alt="" className="img-fluid" />
                                    </div>
                                    <div className="card-body text-center">
                                        <h2>{card.title}</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id, beatae.</p>
                                    </div>
                                    </div>
                                </div>
                            </div>
